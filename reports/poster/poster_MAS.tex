...
TODO: more comments on the figure above...
Across the whole dataset, 8.50\% of the numeric data points are missing values.
The 5 most incomplete variables are missing between 91.52\% and 92.62\% of the data points. On
the other hand, 138 out of the 177 numeric variables have less than 1\% of the data points
missing.
%\end{minipage}
%\vspace{.25cm}
%\medskip
