...
\marginpar{\scriptsize Should I drop the ``automated'' part here? Focus in thesis has mostly been on improving performance, but the methods to do so are also automated as an additional benefit}
...
% TODO: shorten this summary so that total conclusion length is just 3 pages...
\section{Summary}% {{{
\label{sec:Summary}
...
% TODO: squeeze in somewhere the specs of the machine all the experiments were ran on

% TODO: also find somewhere to mention the PyTorch libraries used
