...
if __name__ == "__main__":
    ...
    history = experimentation.cross_validate_model(
        ...
        preprocess_init_fn=lambda : LogStandardScalerTimeSeries(alpha=0.025),
        device_ids=[1],
    )

    np.save(os.path.join(cfg['experiment_directory'], 'log-standard-scaling-history-50-epochs.npy'), history)
